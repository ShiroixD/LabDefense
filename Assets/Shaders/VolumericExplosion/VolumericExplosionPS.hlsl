#ifndef VOLUMERIC_EXPLOSION_PS_INCLUDED
#define VOLUMERIC_EXPLOSION_PS_INCLUDED

#include "VolumericExplosion.hlsli"

float4 PixelProgram(PS_INPUT i) : SV_TARGET
{
...
#endif // VOLUMERIC_EXPLOSION_PS_INCLUDED