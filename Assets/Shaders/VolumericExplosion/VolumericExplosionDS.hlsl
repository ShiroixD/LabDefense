#ifndef VOLUMERIC_EXPLOSION_DS_INCLUDED
#define VOLUMERIC_EXPLOSION_DS_INCLUDED

#include "VolumericExplosion.hlsli"

[domain("quad")]
PS_INPUT DomainProgram(HS_CONSTANT_DATA_OUTPUT input, float2 UV : SV_DomainLocation, const OutputPatch<HS_OUTPUT, 4> quad)
{
...
#endif // VOLUMERIC_EXPLOSION_DS_INCLUDED